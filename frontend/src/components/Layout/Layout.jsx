...
import {
  ...
  Sun, Moon, MessageSquare, KeyRound, Eye, EyeOff, Users, GraduationCap, Truck, ShieldAlert, UserCheck,
} from 'lucide-react';
...
const navItems = [
  ...
  { to: '/marshal-deployment', icon: UserCheck,      label: 'Marshal Deploy',  permission: 'marshal.view'    },

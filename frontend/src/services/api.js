...
export const leaveApi = {
  ...
  shifts:        (p)        => api.get('/leave/shifts',   { params: p }),
  importShifts:  (d)        => api.post('/leave/shifts/import', d),
  clearShifts:   (p)        => api.delete('/leave/shifts', { params: p }),
  ...
  absences:          (p)   => api.get('/leave/absences',            { params: p }),
  logAbsence:        (d)   => api.post('/leave/absences', d),
  updateAbsence:     (id,d)=> api.put(`/leave/absences/${id}`, d),
  deleteAbsence:     (id)  => api.delete(`/leave/absences/${id}`),
  absenceAnalytics:  (p)   => api.get('/leave/absences/analytics',  { params: p }),
...
export const grievanceApi = {
  ...
  listStatements:   (id)      => api.get(`/grievances/${id}/statements`).then(r => r.data),
  requestStatement: (id, d)   => api.post(`/grievances/${id}/statements`, d).then(r => r.data),
  deleteStatement:  (id, sid) => api.delete(`/grievances/${id}/statements/${sid}`).then(r => r.data),
};

export const statementApi = {
  getByToken:    (token) => api.get(`/statements/${token}`).then(r => r.data),
  submitByToken: (token, d) => api.post(`/statements/${token}`, d).then(r => r.data),
};
